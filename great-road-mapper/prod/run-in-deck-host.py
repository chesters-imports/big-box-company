#!/usr/bin/env python3
"""Great Road Mapper → The Deck Host"""
...
URL = os.environ.get("GRM_URL", "http://127.0.0.1:42960/")
HEALTH = os.environ.get("GRM_HEALTH", "http://127.0.0.1:42960/api/health")
...
def main() -> int:
    ...
    print("Great Road Mapper · Big Box Company · The Deck Host")
